...
import { data as togglekilltrackerData, execute as togglekilltrackerExecute } from './commands/togglekilltracker.js'; // Import new command
...
const commands = [landData, playersData, trackData, untrackData, repData, trackedData, playerData, lowreptrackData, togglekilltrackerData]; // Add new command
...
client.on('interactionCreate', async interaction => {
    ...
    switch (interaction.commandName) {
        ...
        case 'togglekilltracker': await togglekilltrackerExecute(interaction); break; // Handle new command
    }
});
